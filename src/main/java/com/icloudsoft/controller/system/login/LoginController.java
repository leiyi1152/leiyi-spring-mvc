package com.icloudsoft.controller.system.login;
...
import com.icloudsoft.entity.system.Menu;
import com.icloudsoft.entity.system.Role;
import com.icloudsoft.entity.system.User;
import com.icloudsoft.service.system.menu.MenuService;
import com.icloudsoft.service.system.role.RoleService;
import com.icloudsoft.service.system.user.UserService;
import com.icloudsoft.util.AppUtil;
import com.icloudsoft.util.Const;
import com.icloudsoft.util.DateUtil;
import com.icloudsoft.util.PageData;
import com.icloudsoft.util.RightsHelper;
	...
	public Object login()throws Exception{
		...
		if(null != KEYDATA && KEYDATA.length == 3){
			...
			String sessionCode =(String) getRequest().getSession().getAttribute(  
					 com.google.code.kaptcha.Constants.KAPTCHA_SESSION_KEY);//获取session中的验证码
	...
	public ModelAndView login_index(@PathVariable("changeMenu") String changeMenu){
		...
		try{
			...
			if (user != null) {
				...
				session.setAttribute(Const.SESSION_menuList,allmenuList);//设置菜单
